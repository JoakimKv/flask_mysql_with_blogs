-- Copies data from the productiondatabase 'db_flask1' to the
-- testdatabase 'carved_rock_test' in HeidiSQL.
...
SELECT `version_num`
FROM `db_flask1`.`alembic_version`;
...
FROM `db_flask1`.`tags_association`;
